...
class ACMEChiefTest(unittest.TestCase):
    ...
    def test_create_initial_tests(self, certificate_version_mock, push_live_mock, cert_mock, self_signed_cert_mock):
        ...
        cert_mock.assert_has_calls([mock.call(self_signed_cert_pem),
                                    ...
                                    file_type='cert',
                                    kind='new',
                                    cert_type='alt_chain_only'), mode=CertificateSaveMode.CHAIN_ONLY, embedded_key=None,
                                    ...
                                    file_type='cert',
                                    kind='new',
                                    cert_type='full_alt_chain'), mode=CertificateSaveMode.FULL_CHAIN, embedded_key=None,
                                    alternative_chain=True),
                                    mock.call().save(
                                    self.instance._get_path('test_certificate',
                                    'rsa-2048',
                                    file_type='cert',
                                    kind='new',
                                    cert_type='full_alt_chain_key'), mode=CertificateSaveMode.FULL_CHAIN, embedded_key=rsa_key_mock.return_value,
                                    alternative_chain=True),
                                    ])
